...
<head>
  ...
  <title>UUX-Posts | Extração de PRUs</title>
  ...
  <div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li>Avaliações</li><li class="active">Extração de PRUs</li>
      </ol>
    </section>
          ...
          <div class="box box-solid">
              <div class="box box-widget widget-user">
                <div class="widget-user-header bg-black" style="height: 250px;
                     background: url('../../../images/ExtracaoPrus.svg') center center; position: relative">
                    <div style="width: 100%; left: 0; top: 0; background-color: #3c8dbc;  position: absolute;">
                        <h3 style="color: white; padding-left: 15px; padding-top: 10px" class="widget-user-username">Etapa 2 - Extração das PRUs</h3>
                ...
                <div class="box-body">
                    <ul class="timeline">
                        ...
                        <li>
                          ...
                          <div class="timeline-item">
                              <h3 class="timeline-header"><strong>ETAPA 2 - Extração das PRUs</strong></h3>
                          </div>
                        </li>
