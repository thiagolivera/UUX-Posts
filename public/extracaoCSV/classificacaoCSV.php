...
class ClassificacaoBD extends Banco {
    ...
    private function buscarFiltro($filtro){
        ...
        foreach ($filtro as $filtro){
            ...
            if(strcmp($filtro, "Substantivos") == 0){
            ...
            if(strcmp($filtro, "Aprendizado") == 0){
