          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  Thiago H. O. Silva - Avaliador
                  <small>Membro desde Outubro - 2015</small>
                </p>
              </li>
              <!-- Menu Footer-->
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active">
            <a href="index.php">
            <i class="fa fa-th"></i> <span>Minhas avalições</span>
          </a>
        </li>
        ...
        <div class="col-md-4 col-sm-8 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Total de postagens classificadas</span>
