...
if (isset($_POST["avaliadores"])) {
    ...
    if (($_POST["postInicial"] > $numTotalPostagens) || ($_POST["postFinal"] > $numTotalPostagens) || ($_POST["postFinal"] < $_POST["postInicial"])) {
        ...
        if ($avaliadoresControle->inserirAvaliador($avaliador)) {
            $avaliadoresControle->notificarInclusao($avaliadoresControle->obterNomeAvaliacao($avaliador->idAvaliacao), $avaliadoresControle->obterNomeAvaliador($avaliador->idPessoa), $avaliador->papel, $avaliador->email);
...
if (isset($_GET["excluir"])) {
    ...
    if ($avaliadoresControle->excluirAvaliador($avaliador)) {
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <div class="alert alert-success alert-dismissible" id="alertaSucesso" style="display: none">
                        ...
                        O avaliador foi adicionado com sucesso! Um aviso foi enviado para ele por e-mail.
                    </div>
                            ...
                            <div class="box box-default">
                                ...
                                <div class="box-body" style="padding-left: 15px; padding-right: 15px">
                                    <table id="example3" class="table table-bordered table-hover text-center">
                                        ...
                                        <tbody>
                                            <?php for ($i = 0; $i < count($categoriasClassificacao); $i++) { ?>
                                                <?php
                            ...
                            <div class="box box-default">
                                ...
                                <div class="box-body" style="padding-left: 15px; padding-right: 15px">
                                    <table id="example1" class="table table-bordered table-hover text-center">
                                        ...
                                        <tbody>
                                            <?php for ($i = 0; $i < count($classificadores); $i++) { ?>
                                                <tr>
