                            ...
                            <div class="row">
                                <form action="" method="POST">
                                    <div class="col-md-6" style="display: flex; justify-content: center; padding-top: 15px">
                                        <button type="button" onclick="deshabilita()" class="btn btn-default pull-left" data-toggle="modal" data-target="#modal-avaliacoes" style="width: 350px">
                                ...
                                <form class="form-horizontal" action="" method="POST" id="formCategorias" style="padding-right: 20px; padding-left: 10px">
                                    <div class="form-group" style="padding-left: 20px">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" id="proximo" class="btn btn-primary" data-target="#modal-categorias" data-toggle="modal" disabled="disabled"> Próximo </button>
                                        </div>
                                </form>
                            </div>
                        </div>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="col-sm-6">
                                                    <label style="font-weight: 500;">
                                                        <input type="checkbox" name="Verbos" class="minimal"> Classificação por verbos
                                                    </label>
                                                    <br>

                                                    <label style="font-weight: 500;">
                                                        <input type="checkbox" name="Substantivos" class="minimal"> Classificação por substantivos
                                                    </label>
                                                    <br>

                                                    <label style="font-weight: 500;">
                                                        <input type="checkbox" name="Adjetivos" class="minimal"> Classificação por adjetivos
                                                    </label>
                                                    <br>

                                                    <label style="font-weight: 500;">
                                                        <input type="checkbox" name="Adverbios" class="minimal"> Classificação por adverbios
                                                    </label>
                                                    <br>

                                                    <label style="font-weight: 500;">
                                                        <input type="checkbox" name="Comparacao" class="minimal"> Classificação por comparações
                                                    </label>
                                                    <br>

                                                    <label style="font-weight: 500;">
                                                        <input type="checkbox" name="Elogio" class="minimal"> Classificação por elogios
                                                    </label>
                                                    <br>

                                                    <label style="font-weight: 500;">
                                                        <input type="checkbox" name="Duvida" class="minimal"> Classificação por dúvidas
                                                    </label>
                                                    <br>

                                                    <label style="font-weight: 500;">
                                                        <input type="checkbox" name="Critica" class="minimal"> Classificação por críticas
                                                    </label>
                                                    <br>

                                                    <label style="font-weight: 500;">
                                                        <input type="checkbox" name="Sugestao" class="minimal"> Classificação por sugestões
                                                    </label>
                                                    <br>
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <label style="font-weight: 500;">
                                                        <input type="checkbox" name="Eficiencia" class="minimal"> Classificação por eficiência
                                                    </label>
                                                    <br>

                                                    <label style="font-weight: 500;">
                                                        <input type="checkbox" name="Estetica" class="minimal"> Classificação por estética
                                                    </label>
                                                    <br>

                                                    <label style="font-weight: 500;">
                                                        <input type="checkbox" name="Frustracao" class="minimal"> Classificação por frustrações
                                                    </label>
                                                    <br>

                                                    <label style="font-weight: 500;">
                                                        <input type="checkbox" name="Motivacao" class="minimal"> Classificação por motivações
                                                    </label>
                                                    <br>

                                                    <label style="font-weight: 500;">
                                                        <input type="checkbox" name="Satisfacao" class="minimal"> Classificação por satisfações
                                                    </label>
                                                    <br>

                                                    <label style="font-weight: 500;">
                                                        <input type="checkbox" name="Seguranca" class="minimal"> Classificação por segurança
                                                    </label>
                                                    <br>

                                                    <label style="font-weight: 500;">
                                                        <input type="checkbox" name="Suporte" class="minimal"> Classificação por suporte
                                                    </label>
                                                    <br>
